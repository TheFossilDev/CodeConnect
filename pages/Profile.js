...
import { FaMapPin, FaPaperclip, FaGraduationCap, FaBuilding, FaPhoneAlt, FaEnvelope } from "react-icons/fa";
  ...
  <>
    ...
    <div className="flex justify-evenly m-6">
      <div className="shadow-md bg-slate-100 h-96 w-96 rounded-xl">
        ...
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus vulputate erat vitae enim commodo vehicula. Nam velit magna, dictum nec risus a, molestie rhoncus nunc. Duis ac ante eu orci lacinia faucibus et et orci.</p>
        <h3 className="text-center">Work Experience:</h3>
        <p>Ice cream store manager: I worked at an ice cream store</p>
      </div>
      <div className="shadow-md bg-slate-100 h-96 w-96 rounded-xl"> 
        <h2 className="text-center">Active Projects</h2>
        <ProjectCard title="362 Proj" desc="Cool project for 362" workType="Creator" />
        <ProjectCard title="362 Proj" desc="Cool project for 362" workType="Creator" />
      </div>
      <div className="shadow-md bg-slate-100 h-96 w-96 rounded-xl">
