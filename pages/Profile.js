import { FaCrown, FaPlus, FaUserClock, FaUserCircle } from "react-icons/fa";
        ...
        <div className="h-full flex flex-col justify-start items-center">
          ...
          <FlatOutlineCard className="w-4/5 h-2/5 my-5 flex justify-evenly items-center">
            ...
            <div className="flex flex-col justify-start items-start w-[32rem] h-fit bg-white border-2 border-gray-200 rounded-lg p-2">
              ...
              <p className="m-1 text-gray-500">Very popular media player compatible with every system. Open source and developed entirely by the community</p>
          ...
          <div className="flex justify-center items-center h-2/5 w-4/5">
            ...
            <FlatOutlineCard className="h-full p-2 mx-6 flex-shrink-0 flex-grow basis-1/3">
              ...
              <div onClick={() => router.push("/projects")} className="hover:bg-sky-500 bg-sky-400 w-full m-h-10 h-fit p-3 cursor-pointer rounded-lg flex justify-center">
                <button className="text-white font-bold text-center">No projects yet, add one</button>
              </div>
            </FlatOutlineCard>
